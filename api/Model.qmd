...
=======
        the actual intercept in all distributional components that have an intercept.  Note 
>>>>>>> d40a1d84 (Clarified that centering affects prior interpretation in models.py)
=======
        the actual intercept in all distributional components that have an intercept. Note
>>>>>>> d6a6b7c9 (Applied black to make CI happy. Problem must have been some invisible character, or so.)
